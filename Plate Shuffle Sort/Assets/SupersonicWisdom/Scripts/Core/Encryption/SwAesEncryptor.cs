...
{
    internal static class SwAesEncryptor
    {
        #region --- Constants ---
        ...
        internal static string DecryptAes(byte[] encryptedText, string key, string iv)
        {
            ...
            {
                SwInfra.Logger?.LogError(EWisdomLogType.Encryptor, $"Failed to encrypt byes: is null = {encryptedText == null}, key: {key ?? "null"}, iv: {iv ?? "null"}");
