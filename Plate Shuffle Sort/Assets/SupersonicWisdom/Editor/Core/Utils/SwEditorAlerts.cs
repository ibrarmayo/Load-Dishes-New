...
namespace SupersonicWisdomSDK.Editor
{
    public static class SwEditorAlerts
    {
        ...
        public static bool AlertFailedToUpdateWisdomPackage(string errorMessageDetails)
        {
            return AlertError(SwEditorConstants.UI.FAILED_TO_UPDATE_WISDOM_PACKAGE(errorMessageDetails), (int)SwErrors.ESelfUpdate.ImportFailed, SwEditorConstants.UI.ButtonTitle.CLOSE);
        }
