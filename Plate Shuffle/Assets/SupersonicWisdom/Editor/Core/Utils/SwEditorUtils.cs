...
namespace SupersonicWisdomSDK.Editor
{
    public class SwEditorUtils
    {
        ...
        internal static string SwUpdateMetadataFolderPath(bool hidden) => (hidden ? SwFileUtils.HIDDEN_FILE_PREFIX : string.Empty) + SwFileUtils.DirectorySeparatorChar + SwEditorConstants.ASSETS + SwFileUtils.DirectorySeparatorChar + SUPERSONIC_WISDOM_RESOURCE_DIR_NAME + SwFileUtils.DirectorySeparatorChar + (hidden ? SwFileUtils.HIDDEN_FILE_PREFIX : string.Empty) + SW_UPDATE_METADATA_FOLDER_NAME;

        public static string SwUpdateMetadataExposedFolderPath
        {
            get { return SwUpdateMetadataFolderPath(true).Replace($"{SUPERSONIC_WISDOM_RESOURCE_DIR_NAME}{SwFileUtils.DirectorySeparatorChar}{SwFileUtils.HIDDEN_FILE_PREFIX}", SUPERSONIC_WISDOM_RESOURCE_DIR_NAME + SwFileUtils.DirectorySeparatorChar); }
        }
        ...
        public static string GetWisdomPackageContentFileName()
        {
            return $"{SwConstants.SdkVersion}-contents.txt";
        }
    }
