namespace SupersonicWisdomSDK.Editor
{
    internal static class SwEditorConstants
    {
        ...
        #if SW_STAGE_STAGE2
        public const string DEFAULT_STAGE_INTEGRATION_GUIDE_URL = "https://support.supersonic.com/hc/en-us/articles/9945166026525-Wisdom-SDK-Integration-Guide-Stage-2";
        #elif SW_STAGE_STAGE3
        public const string DEFAULT_STAGE_INTEGRATION_GUIDE_URL = "https://support.supersonic.com/hc/en-us/articles/9961385042589-Wisdom-SDK-Integration-Guide-Stage-3";
        #else
        ...
        internal struct ErrorMessages
        {
            ...
            public const string FAILED_TO_BACKUP = "Failed to backup current package content";
            public const string FAILED_TO_DELETE_CURRENT_VERSION = "Failed to delete all current package content";
            public const string FAILED_TO_IMPORT_PACKAGE = "Failed to import updated package";
            public const string FAILED_TO_VERIFY_SUCCESSFUL_UPDATE = "Failed to verify successful update";
