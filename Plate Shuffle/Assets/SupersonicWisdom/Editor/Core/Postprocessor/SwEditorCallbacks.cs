...
{
    public class SwEditorCallbacks : UnityEditor.Build.IPreprocessBuildWithReport
    {
        #region --- Construction ---
        ...
        private static void InjectPackageJsonDependenciesIfNeeded()
        {
        ...
        /// Returns the most derived type of specific type, assuming the inheritance is linear and each base class has one subclass, for example: SwStage1Editor inherits from SwStageEditor, SwStage2Editor inherits from SwStage1Editor, and so on...
